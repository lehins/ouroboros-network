...
instance SerialiseNodeToClient blk TriggerHardFork where
  encodeNodeToClient _ _ triggerHardFork = case triggerHardFork of
    TriggerHardForkAtVersion v -> encodeListLen 2 <> encodeTag 0 <> toCBOR v
    TriggerHardForkAtEpoch e   -> encodeListLen 2 <> encodeTag 1 <> toCBOR e
    TriggerHardForkNever       -> encodeListLen 1 <> encodeTag 2
